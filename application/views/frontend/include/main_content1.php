  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <form class="navbar-form navbar-left" id="form" method="post" action="<?php echo base_url('Welcome/search')?>">
        <div class="input-group">
          ...
          <button class="close-icon" type="reset" onclick="myFunction()"></button>
    ...
    <div class="row">
      ...
      <div class="col-sm-2">
          ...
          <div class="list-group">
              <a style="color:black;" data-toggle="collapse"  class="list-group-item panel-title" href="#lesscategory">
                <span id="AccordionHeadings" style="font-size:14px">Filter By Category</span> 
              </a>
              <div  id="lesscategory" class="collapse" data-parent="#accordion" >
          ...
          <div id="more-category" >
           <?php if (!empty($category_data)) {?>
          <div class="list-group">
              <a style="color:black;" data-toggle="collapse"  class="list-group-item panel-title" href="#category">
                <span style="font-size:14px"  id="AccordionHeadings">Filter By Category</span> 
              </a>
              <div  id="category" class="collapse" data-parent="#accordion">
               <?php  foreach($category_data->result_array() as $row) { ?>
                    <div class="list-group-item checkbox" >
                      <label style="font-size:14px" ><input type="checkbox" class="common_selector ram" id="categorys" value="<?php echo $row['category']; ?>"> <?php echo $row['category']; ?> </label>
                    </div>
                  <?php } ?>
                 <?php if($no_brand > 10){ ?>
                  <div class="list-group-item checkbox"> 
        ...
        <div id="less-brand">
          ...
          <div class="list-group">
             <a style="color:black;" data-toggle="collapse"  class="list-group-item panel-title" href="#Brand">
                <span style="font-size:14px"  id="AccordionHeadings">FIlter By Brand</span> 
              </a>
              <div id="Brand" class="collapse" data-parent="#accordion">
            <?php
            $i = 0;
          ...
          <div class="list-group">
            ...
            foreach($brand_data->result_array() as $row)
              {?>
                <div class="list-group-item checkbox"> 
                  <label style="font-size:14px" ><input type="checkbox" class="common_selector brand" id="brands" value="<?php echo $row['brand']; ?>"  > <?php echo $row['brand']; ?></label>
                </div>
                <?php }  ?>
                <div class="list-group-item checkbox"> 
                ...
                <?php foreach ($search as  $pro) { ?>
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-2">
                          <img  src="<?php echo base_url('');?>assets/uploads/90x63.png">
                          <input type="hidden" name="product_id" value="<?php echo $pro->product_id; ?>">
                        </div>
                        <div class="col-md-3">
                          <p align="center" style="margin-bottom:5px"  ><strong><?php echo $pro->product_name; ?></strong></p>
                          <p align="center"  class="text-muted" style="font-size:12px"><?php echo $pro->product_description; ?></p>
                        </div>
                        <div class="col-md-2">
                          <h7 style="margin-top: 15px;"><?php echo $pro->product_brand; ?></h7>
                        </div>
                        <div class="col-md-3">
                          <h7 style="margin-top: 15px;"> &#8377; <?php echo $pro->offer_price; ?><del style="color:#6e6c6c;"> <?php echo $pro->product_price; ?></del></h7>
                        </div>
                        <div class="col-md-2">
                          <a href="<?php echo base_url('welcome/add/'.$pro->product_id.'/'.$pro->product_name.'/'.$pro->product_price)?>"style="margin-top: 25px;" type="button"  class="btn btn-success btn-sm">Add to cart</a>
                        </div>
                      </div>
                    </div>
                  </div>
...
$('#price_range').slider({
  ...
  range:true,
  min:$('#hidden_minimum_price').val()-1,
  max:v2,
  values:[v1, v2],
  step: 10,
