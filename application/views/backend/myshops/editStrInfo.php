											...
											<form action="<?php echo base_url('backend/MyShopController/updateShopDetails');?>" method="post">
												<div class="row">
													<div class="col-md-6">
                                                        ...
                                                        <input type="hidden" class="form-control" name="shop_id" value="<?php if(isset($shopData->shop_id)) { echo $shopData->shop_id; } ?>">
															...
															<div class="col-md-9">
																<form action="<?php echo base_url('backend/ImportExcelController/importUpdatedProductDataToTemp/'.$shopId.'/'.'datafrombaseDB');?>" method="post" enctype="multipart/form-data">
																	<div class="row">
																		...
																		<input type="hidden" name="edit" value="edit" class="form-control">
																		<div class="col-md-1">
