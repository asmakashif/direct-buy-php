			...
			<div class="container-fluid page__container">
				...
				<ul class="nav nav-tabs">
					...
					<?php if($this->uri->segment(5)=='datafrombaseDB') {?>
						<li class="nav-item">
							<a class="nav-link" href="<?php echo base_url('backend/MyShopController/strProductConfig/'.$shopId.'/'.'datafrombaseDB');?>">Product Configuration</a>
					...
					&nbsp;
					<li class="nav-item">
						<a class="nav-link" href="#product_information" data-toggle="tab">Product Information</a>
					</li>
					&nbsp;
					<li class="nav-item">
						<a class="nav-link active" href="#store_summary" data-toggle="tab">Store Summary</a>
					</li>
				</ul>
				<!-- <br> -->
				<div class="">
					<div class="tab-content ">
						...
						<div class="tab-pane active" id="store_summary">
							<br>
							<div class="card" >
								<div class="card-body">
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-9">
											...
											<?php } elseif($shopSummary->upload_status=='Fully uploaded by customer') {?>
