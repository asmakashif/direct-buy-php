         ...
         <div class="container-fluid page__container">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <form  action="<?php echo base_url('backend/MyShopController/updateCustomerOrder/'.$shopId);?>" method="post">
                     <?php if(isset($orderData) && is_array($orderData) && count($orderData)): $i=1;
                     foreach ($orderData as $key => $data) { 
                        ?>
                        <div class="row">
                           <input type="hidden" class="form-control" name="order_code" value="<?php echo $data['order_code'];?>">
                        </div>
                           ...
                           <div class="row">
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <input type="hidden" id="orderAccepted" name="orderAccepted" class="form-control" value="1">
                                    <input type="submit" name="orderAccept" class="btn btn-success" value="Order Complete">
                                 </div>
                              </div>
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <!--<a target="_blank" href="https://print.direct-buy.in/index.php/<?php echo $data['order_code']?>/<?php echo $data['shopId']?>" id="printButton" class="btn btn-success">Print</a>-->
                                    
                                    <a target="_blank" href="<?php echo base_url('backend/MyShopController/printData/'.$data['order_code'].'/'.$shopId);?>" class="btn btn-success" >Print</a>
                                 </div>
                              </div>
                           </div>
                        <?php }?>
