					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<form action="<?php echo base_url('backend/MyShopController/migrateMultiDataToStoreDb/'. $fetchdatabyid->shopId .'/'. $fetchdatabyid->shop_db_name);?>" method="post">
									<?php foreach($category as $row) {?>
										<input type="checkbox" id="<?=$row->categoryId?>" name="categoryId[]" value="<?php echo $row->categoryId ;?>">
	  									<label for="vehicle1"><?php echo $row->category_name;?></label><br>
	  								<?php }?>
